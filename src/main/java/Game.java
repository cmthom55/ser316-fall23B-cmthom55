...
/**
 * Class for handling game logic for the hangman game.
 * Every game starts with a score of 10 and points are reduced based on "makeGuess."
 * The game is lost when the score is 0 or less.
 * "Answer" holds the current answer, and "progress" holds the current word with "_".
 */
public class Game {
    ...
    // all letter guesses, need to be cleared for each game
     ...
     * @param letter The letter to set in the progress.
     * @return int The count of letters set in progress.
     */
     ...
     * @return int The number of letters turned in progress.
     */
     ...
     *
     * @param guess The guess to be made.
     ...
     * @param choice The choice of image type ("city" or "country").
     */
